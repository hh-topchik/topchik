...
public class CommitDaoImplTest {
  private static EmbeddedPostgres embeddedPostgres = null;

  @InjectMocks
  private CommitDaoImpl commitDao = new CommitDaoImpl();
  ...
  @Test
  public void getAggregatedDailyAddedLinesShouldReturnCorrectAmountOfCommits() {
    insertData();
    PowerMockito.mockStatic(HibernateUtil.class);
    PowerMockito.when(HibernateUtil.getSessionFactory()).thenReturn(createSessionFactory());
    List<CommonCountPojo> pojos = commitDao.getAggregatedDailyAddedLines();
    Assertions.assertThat(pojos.size()).isEqualTo(8);
  }

  @Test
  public void getAggregatedDailyAddedLinesShouldFilterBot() {
    insertData();
    PowerMockito.mockStatic(HibernateUtil.class);
    PowerMockito.when(HibernateUtil.getSessionFactory()).thenReturn(createSessionFactory());
    List<CommonCountPojo> pojos = commitDao.getAggregatedDailyAddedLines();
  ...
  @Test
  public void getAggregatedDailyAddedLinesShouldContainCorrectAddedLinesAmount() {
    insertData();
    PowerMockito.mockStatic(HibernateUtil.class);
    PowerMockito.when(HibernateUtil.getSessionFactory()).thenReturn(createSessionFactory());
    List<CommonCountPojo> pojos = commitDao.getAggregatedDailyAddedLines();
    Assertions.assertThat(pojos.stream().anyMatch(p -> p.getCount() == 215)).isTrue();
  }

  @Test
  public void getAggregatedWeeklyAddedLinesShouldReturnCorrectAmountOfApprovedPR() {
    insertData();
    PowerMockito.mockStatic(HibernateUtil.class);
    PowerMockito.when(HibernateUtil.getSessionFactory()).thenReturn(createSessionFactory());
    List<CommonCountPojo> pojos = commitDao.getAggregatedWeeklyAddedLines();
    Assertions.assertThat(pojos.size()).isEqualTo(6);
  }

  @Test
  public void getAggregatedWeeklyAddedLinesShouldFilterBot() {
    insertData();
    PowerMockito.mockStatic(HibernateUtil.class);
    PowerMockito.when(HibernateUtil.getSessionFactory()).thenReturn(createSessionFactory());
    List<CommonCountPojo> pojos = commitDao.getAggregatedWeeklyAddedLines();
  ...
  @Test
  public void getAggregatedWeeklyAddedLinesShouldContainCorrectAddedLinesAmount() {
    insertData();
    PowerMockito.mockStatic(HibernateUtil.class);
    PowerMockito.when(HibernateUtil.getSessionFactory()).thenReturn(createSessionFactory());
    List<CommonCountPojo> pojos = commitDao.getAggregatedWeeklyAddedLines();
    Assertions.assertThat(pojos.stream().anyMatch(p -> p.getCount() == 188)).isTrue();
  }

  @Test
  public void getAggregatedWeeklyAddedLinesShouldNotContainsNotSundayWeekDate() {
    insertData();
    PowerMockito.mockStatic(HibernateUtil.class);
    PowerMockito.when(HibernateUtil.getSessionFactory()).thenReturn(createSessionFactory());
    List<CommonCountPojo> pojos = commitDao.getAggregatedWeeklyAddedLines();
